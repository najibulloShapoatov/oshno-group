        ...
        <content>
            ...
            <div class="col-lg-4 col-sm-6 col-12 oshno-card-item mt-4">
                <div>
                    ...
                    <button data-type="{{ App\Models\Enums\ProductType::$IPPHONE }}" data-id="{{ $item->id }}" class="btn oshno-btn-card mt-3" data-toggle="modal" onclick="byProduct(event);" data-target="#modalSite">Подключить</button>
                </div>
            </div>
        @endforeach
                </div>
