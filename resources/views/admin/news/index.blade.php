...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-12 mb-30">
            <a href="/admin/news/create" class="button button-my float-right"><span><i class="ti-plus"></i>Добавить</span></a>
        </div>
                        ...
                        <tbody>
                            @foreach($news as $item)
                                <tr>
                                    ...
                                    <td><strong>{!! mb_substr($item->title, 0, 150) !!}</strong></td>
                                    <td>
                                        @if($item->is_active)
                                    ...
                                    <td width="170" class="text-center act"  style="vertical-align: middle">
                                        ...
                                        <a href="/admin/news/destroy/{{$item->id}}">
