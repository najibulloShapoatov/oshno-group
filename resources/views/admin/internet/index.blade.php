...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-12 mb-30">
            <a href="/admin/product-internet/create" class="button button-my float-right"><span><i class="ti-plus"></i>Добавить</span></a>
        </div>
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td width="70" class="text-center act"  style="vertical-align: middle">
                                        <a href="/admin/product-internet/edit/{{$item->id}}">
                                        <span  class="ti-pencil edit-item mr-10"></span>
                                        </a>
                                        <a href="/admin/product-internet/destroy/{{$item->id}}">
