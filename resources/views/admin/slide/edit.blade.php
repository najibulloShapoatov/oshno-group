                            ...
                            <div class="row mbn-20">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <div class="row mbn-15">
                                        <form action="/admin/slide/update/{{ $data->id }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-12 mb-15">
                                        <textarea name="subtitle" class="form-control summernote" placeholder="Подзаголовок">
                                        {!! $data->subtitle !!}
                                        </textarea>
                                        </div>
