...
@section('title', 'Вакансии создания')
    ...
    <!-- Page Heading Start -->
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3 class="title">Вакансии создания</h3>
                        ...
                        <div class="box-body">
                            <div class="row mbn-20">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <form action="/admin/vacancies/store" method="post" enctype="multipart/form-data" style="width:100%;">
                                        @csrf
