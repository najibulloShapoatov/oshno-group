...
@section('title', 'Вакансии редактирования')
    ...
    <!-- Page Heading Start -->
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3 class="title">Вакансии редактирования</h3>
                            ...
                            <div class="row mbn-20">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <div class="row mbn-15">
                                        <form action="/admin/vacancies/update/{{ $data->id }}" method="post" enctype="multipart/form-data" style="width:100%;">
                                        @csrf
                                        ...
                                        <div class="col-12 mb-15">
                                        <textarea required name="short_description" class="form-control " placeholder="Короткое описания">
                                        {!!$data->short_description!!}
                                        </textarea>
                                        <textarea required name="description" class="form-control summernote" placeholder="Описания">
