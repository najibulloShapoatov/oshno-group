    ...
    <!-- Page Heading Start -->
        <div class="col-12 col-lg-auto mb-20">
            <div class="page-heading">
                <h3 class="title">Домен создания</h3>
                        ...
                        <div class="box-body">
                            <div class="row mbn-20">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <form action="/admin/domains/store" method="post" enctype="multipart/form-data" style="width:100%;">
                                        @csrf
                                        ...
                                        <div class="col-12 mb-15">
                                        <input required name="registration_price" type="text" class="form-control" placeholder="Заголовок" >
                                        </div>
                                        <div class="col-12 mb-15">
                                        <input required name="renewal_price" type="text" class="form-control" placeholder="Заголовок" >
                                        </div>
                                        <div class="col-12 mb-15">
                                        <input required name="transfer_price" type="text" class="form-control" placeholder="Заголовок" >
                                        </div>
